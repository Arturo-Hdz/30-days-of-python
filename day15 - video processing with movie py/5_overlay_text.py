...
from typing import Concatenate, Text, final, overload
from webbrowser import BackgroundBrowser
from conf import SAMPLE_INPUTS, SAMPLE_OUTPUTS
from moviepy.editor import *
from PIL import Image

source_path = os.path.join(SAMPLE_INPUTS, 'beatles.mp4')
source_audio_path = os.path.join(SAMPLE_INPUTS, 'audio.mp3')


mix_audio_dir = os.path.join(SAMPLE_OUTPUTS, "overlay-audio")
